...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if arguments.operation == "plan":
            if arguments.allow_incomplete or arguments.fail_fast or arguments.workers != 1:
        ...
        if arguments.scenario_id or arguments.max_runs is not None or arguments.fail_fast or arguments.workers != 1:
