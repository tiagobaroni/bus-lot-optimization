...
Esse pacote foi compactado e disponibilizado separadamente, e o link para
download foi compartilhado por meio do Moodle da disciplina. Baixe o
arquivo compactado e descompacte-o de modo que o conteúdo fique
diretamente sob o diretório

\begin{verbatim}
_temp/dados_artesp/
\end{verbatim}

criando-o se necessário. Ao final, esse diretório deve conter os arquivos
de dados de origem e o \texttt{manifest.json} que os descreve. O
diretório \texttt{\_temp/} é ignorado pelo controle de versão, de modo que
o pacote não interfere no estado do repositório.
