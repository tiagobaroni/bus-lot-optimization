...
(desvio-padrão) sobre as 18 combinações é $0{,}012639$ para a Busca
...
médio de execução (tempo médio) entre os três algoritmos em 16
delas. A média de tempo médio sobre as 18 combinações é
...
\clearpage
\appendix
\input{tabelas/resultados_complementares}
\clearpage
